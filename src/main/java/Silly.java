...
public class Silly implements Comparable<Silly>{
     ...
     *
     * @param para1 The first String parameter of this function.
     * @param para2 The second String parameter of this function.
     */
    public Silly(String para1, String para2) {
        this.name = para1 + para2;
    }
